    ...
    <div className="min-h-screen bg-[#EBEBEB] flex flex-col font-sans">
      <header className="px-8 py-8 lg:px-12 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#10367D] rounded-xl flex items-center justify-center shadow-lg shadow-[#10367D]/20">
            <span className="text-white font-black text-xs">EQ</span>
          </div>
          <div>
            <h1 className="text-2xl font-black text-slate-900 tracking-tight leading-none uppercase text-[#10367D]">
              EARIST Kiosk
            </h1>
        ...
        <div className="bg-white px-6 py-3 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-6">
          <div className="text-right">
            ...
            <div className="text-[10px] font-bold text-slate-400 uppercase mt-1">{formattedDate}</div>
          </div>
      ...
      <main className="flex-1 px-8 pb-10 lg:px-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-3 gap-8">
          <Card className="border-0 shadow-[0_30px_60px_rgba(0,0,0,0.08)] rounded-[40px] overflow-hidden bg-white">
            <div className="bg-[#10367D] pt-12 pb-8 px-8 text-center relative overflow-hidden">
              ...
              <p className="text-[#EBEBEB] font-medium mt-2 relative z-10 text-sm">
                Scan Student ID to book
              </p>
            </div>

            <CardContent className="px-8 py-8 space-y-6">
              <div className="p-6 rounded-[28px] bg-[#A5CEE0]/40 border-2 border-dashed border-[#A5CEE0] text-center flex flex-col items-center">
                <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-sm mb-4">
                  <ScanBarcode className="w-7 h-7 text-[#10367D] animate-pulse" />
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    disabled={loading}
                    className="text-center font-mono h-14 border-slate-100 focus-visible:ring-4 focus-visible:ring-[#A5CEE0] focus-visible:border-[#10367D] rounded-[20px] text-lg bg-slate-50 font-bold"
                  />
                </div>

                <Button
                  type="submit"
                  className="w-full bg-[#10367D] hover:bg-[#10367D] text-white font-black h-14 text-base rounded-[20px] shadow-xl transition-all uppercase tracking-[0.1em]"
                  disabled={loading}
                >
                  {loading ? (
              ...
              >
                <DialogContent className="rounded-3xl border-0 shadow-2xl p-0 overflow-hidden bg-white max-w-md">
                  <DialogHeader className="bg-[#10367D] text-white p-6">
                    <DialogTitle className="text-2xl font-black uppercase tracking-tight">
                      Confirm Identity
                    </DialogTitle>
                    <p className="text-[11px] text-[#EBEBEB] font-bold uppercase tracking-wider mt-2">
                      Student ID is protected
                    </p>
                  </DialogHeader>

                  <div className="p-6 space-y-4">
                    <div className="rounded-2xl bg-[#A5CEE0]/30 border border-[#A5CEE0] p-4">
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">
                        Student ID
                      </p>
                      <p className="text-lg font-black text-[#10367D]">
                  ...
                  <DialogFooter className="p-6 pt-0 grid grid-cols-2 gap-3">
                    ...
                    <Button
                      ...
                      disabled={loading || isResolvingStudent}
                      className="w-full rounded-xl h-12 bg-[#10367D] hover:bg-[#10367D] text-white text-[10px] font-black uppercase tracking-widest"
                    >
                      Continue
                    </Button>
                  </DialogFooter>
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                ...
                <Dialog>
                  ...
                  <DialogContent className="rounded-[40px] max-w-2xl border-0 shadow-2xl p-0 overflow-hidden bg-white">
                    <DialogHeader className="bg-[#10367D] p-8 text-white relative">
                      <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-bl-full -mr-8 -mt-8" />
                      <div className="flex justify-between items-center relative z-10">
                        <div>
                          ...
                          <p className="text-[#EBEBEB] text-xs opacity-80 uppercase tracking-widest font-bold mt-1">
                            Live Availability
                          </p>
                        </div>
                        ...
                        filteredFaculties.map((f) => (
                          ...
                          >
                            <div className="flex items-center gap-5">
                              <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-[#10367D] font-black text-xl shadow-sm uppercase border border-[#A5CEE0]">
                                {f.name[0]}
                              </div>
                              <div>
                            ...
                            <div className="flex items-center gap-2 bg-[#A5CEE0]/30 text-[#10367D] px-4 py-2 rounded-xl border border-[#A5CEE0] shadow-sm">
                              <div className="w-2 h-2 rounded-full bg-[#10367D] animate-pulse" />
            ...
            <CardContent className="p-8 h-full flex flex-col">
              <div className="flex items-center justify-between mb-5">
                <h3 className="font-black text-slate-800 uppercase text-xl flex items-center gap-3 tracking-tight">
                  <Monitor size={22} className="text-[#10367D]" /> Live Monitor
                </h3>
                <Badge className="bg-[#A5CEE0]/30 text-[#10367D] border-0 text-[10px] font-black uppercase tracking-wider">
                  Bubble 2
                </Badge>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 my-5">
                <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
                  <p className="text-[9px] font-black uppercase text-slate-400">In Session</p>
                  <p className="text-xl font-black text-[#10367D]">{currentServing ? 1 : 0}</p>
                </div>
                <div className="bg-slate-50 rounded-xl p-3 border border-slate-100">
                  <p className="text-[9px] font-black uppercase text-slate-400">Waiting</p>
                  <p className="text-xl font-black text-[#10367D]">{waitingQueue.length}</p>
                </div>
                <div className="bg-[#10367D] rounded-xl p-3 text-white">
                  ...
                  liveQueue.map((ticket) => (
                    <div key={ticket.id} className="rounded-2xl border border-slate-100 bg-slate-50 p-4 space-y-3">
                      ...
                      <div className="p-3 rounded-xl bg-white border border-slate-100 flex items-center gap-3">
                        <UserCheck className="w-4 h-4 text-[#10367D]" />
                        <div>
                          <p className="text-[10px] font-black text-slate-400 uppercase">Professor</p>
          ...
          <Card className="border-0 shadow-xl rounded-[40px] bg-white overflow-hidden">
            <CardContent className="p-8 h-full flex flex-col">
              <div className="flex items-center justify-between mb-6">
                <h3 className="font-black text-slate-800 uppercase text-xl flex items-center gap-3 tracking-tight">
                  <Calendar size={22} className="text-[#10367D]" /> Prof Schedules
                </h3>
                <Badge className="bg-[#A5CEE0]/30 text-[#10367D] border-0 text-[10px] font-black uppercase tracking-wider">
                  Bubble 3
                </Badge>
              ...
              <div className="p-5 rounded-2xl bg-slate-50 border border-slate-100 mb-4">
                ...
                <div className="flex items-center gap-3">
                  {isOnline ? (
                    <Globe size={20} className="text-[#10367D]" />
                  ) : (
                    <UserCheck size={20} className="text-[#10367D]" />
                  )}
              ...
              <div className="mt-auto pt-5 border-t border-slate-100">
                ...
                <div className="flex items-center justify-between rounded-2xl bg-[#A5CEE0]/30 border border-[#A5CEE0] px-4 py-3">
                  <span className="text-lg font-black text-[#10367D]">
                    {currentServing ? currentServing.student_display_name : "IDLE"}
                  </span>
                  {currentServing && (
                    <span className="text-[10px] font-black uppercase tracking-widest text-[#10367D]">
      ...
      <footer className="px-12 py-8 flex justify-between items-center bg-white border-t border-slate-50">
        ...
        <button
          ...
          className="text-[10px] font-black text-slate-400 hover:text-[#10367D] transition-colors uppercase tracking-[0.2em] border-b border-transparent hover:border-[#10367D]"
        >
          Staff Login
        </button>
      </footer>
